...
function winCheck1() {
    ...
    for (let _col = 0; _col < 7; _col++) {
        for (let _row = 5; _row > -1; _row--) {
            console.log(columns[_col][_row].style.background.color);
            if (columns[_col][_row].style.background == "rgb(124, 0, 132)") {
                alert("its happening");
                count += 1;
                if (count >= 4) {
                    alert("PLAYER 1 WINS!!!");
                ...
                count = 0;
                //alert("did not find _purple here");
            }
        }
    }
    ...
    for (let _row = 0; _row < 6; _row++) {
        for (let _col = 0; _col < 7; _col++) {
            if (rows[_row][_col].style.background == _purple) {
                count += 1;
                if (count >= 4) {
                    alert("PLAYER 1 WINS!!!");
                }
    ...
    for (let _row = 0; _row < 3; _row++) {
        ...
        for (let _col = 0; _col < (6 - iterations); _col++) {
            if (rows[_row + _rowPush][_col].style.background == _purple) {
                count += 1;
                if (count >= 4) {
                    alert("PLAYER 1 WINS!!!");
                }
    ...
    for (let _col = 1; _col < 4; _col++) {
        ...
        for (let _row = 0; _row < (6 - iterations); _row++) {
            if (rows[_row][_col + _colSlide].style.background == _purple) {
                count += 1;
                if (count >= 4) {
                    alert("PLAYER 1 WINS!!!");
                }
...
function winCheck2() {
    ...
    for (let _col = 0; _col < 7; _col++) {
        for (let _row = 5; _row > -1; _row--) {
            console.log(columns[_col][_row].style.background);
